...
public class TestProgramI {
     ...
     * 
     */
    public String testName = "TEST_I_Factorial";

    /**
     * 
     */
    public String assemblySourceFile = GenAsm.CFG_DIR_PATH + "THUMB\\TESTS\\TEST_I_Factorial\\genasm_source.txt";
     ...
     * 
     */
    public String jsonAnswersDataFile = GenAsm.CFG_DIR_PATH + "THUMB\\TESTS\\TEST_I_Factorial\\vasm_answer.json";
    ...
    public void setUp() {
        ...
        mainExeArgs[8] = GenAsm.CFG_DIR_PATH + "THUMB\\OUTPUT\\TEST_I_Factorial\\";
        mainExeArgs[9] = "false";
