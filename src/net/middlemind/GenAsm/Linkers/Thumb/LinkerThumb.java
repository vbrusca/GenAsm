...
/**
 * An implementation of the linker interface used to link areas of a source
 * assembly file for the ARM Thumb instruction set.
 *
...
public class LinkerThumb implements Linker {
   ...
   /**
    * An absolute line position based mapping to a hex, big endian, binary
    * representation.
    */
   public Hashtable<String, String> hexMapBe = null;

   /**
    * An absolute line position based mapping to a hex, little endian, binary
    * representation.
    */
    ...
    *
    * @param assembler An instance of an assembler that can assemble the target
    * source file.
    * @param assemblySourceFile The file path of the assembled source.
    * @param outputDir The target directory for output files.
    * @param otherObj An optional generic object that can be used to customize
    * the linker if applicable.
   ...
   /**
    * A method used to split a binary string into bytes and add them to the data
    * argument.
    *
    * @param binStr The binary string to split into bytes to add to the data
    * argument.
    * @param data A data structure to store the extracted bytes.
    * @return An integer representing the number of bytes added to the data
    * argument.
    */
