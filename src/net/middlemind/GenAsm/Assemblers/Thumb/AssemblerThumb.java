...
public class AssemblerThumb implements Assembler {
   ...
   /**
    * A static string representing the default instruction alignment, WORD or
    * HALFWORD>
    */
   public static String INSTRUCTION_ALIGNMENT_NAME_WORD = "HALFWORD";

   /**
    * A static integer representing the number of bytes used to align the source
    * code.
    */
   public static int INSTRUCTION_ALIGNMENT_BYTES = 2;

   /**
    * A static integer representing the number of bits used to describe one
    * op-code instruction.
    */
   ...
   /**
    * An object representing the instruction set data set of all loaded JSON
    * data file.
    */
   ...
   /**
    * A list of artifact lines representing the tokenization of the lexerized
    * lines.
    */
   ...
   /**
    * An integer representing the number of bytes in one line of assembly
    * source.
    */
   public int lineLenBytes = 2;

   /**
    * An integer representing the number of halfwords in one line of assembly
    * source,
    */
   public int lineLenHalfWords = 1;

   /**
    * An integer representing the number of words in one line of assembly
    * source.
    */
   public int lineLenWords = 0;

   /**
    * An object representing a bit series that describes a line of assembly
    * code.
    */
   public JsonObjBitSeries lineBitSeries;

   /**
    * An object representing a number range that describes a valid integer value
    * of a line of assembly code.
    */
   public JsonObjNumRange lineNumRange;

   /**
    * An integer representing the number of pre-fetch bytes ahead of the PC
    * register value.
    */
   public int pcPreFetchBytes;

   /**
    * An integer representing the number of pre-fetch words ahead of the PC
    * register value.
    */
   public int pcPreFetchWords;

   /**
    * An integer representing the number of pre-fetch half words ahead of the PC
    * register value.
    */
   public int pcPreFetchHalfwords;

   /**
    * An integer representing the starting line number of the assembly source,
    * ORG directive will offset this value.
    */
   public Integer asmStartLineNumber;

   /**
    * A Boolean value indicating if this assembler should be considered little
    * endian.
    */
   public boolean isEndianBig = false;

   /**
    * A Boolean value indicating if this assembler should be considered big
    * endian.
    */
   ...
   /**
    * An object used to respond to assembler events and customize the assembly
    * process.
    */
   public AssemblerEventHandlerThumb eventHandler;

   /**
    * A Boolean value indicating that verbose logging should be used if
    * available.
    */
   ...
   //MAIN METHOD
   /**
    * The main assembler execution method called by the GenAsm static main entry
    * point.
    *
    * @param jsonIsSet The set of JSON data files necessary to assemble the
    * provided source file.
    * @param assemblySourceFile The full file name of the assembly source file.
    * @param assemblySource A list of strings representing the contents of the
    * assembly source file.
    * @param outputDir The full path to an output directory used to write output
    * files to.
    * @param otherObj An optional generic Java object used to customize the
    * assembly process.
    * @param asmEventHandler An optional event handler used to respond to and
    * customize different steps in the assembly process.
    * @param verbose A Boolean value indicating that verbose logging should be
    * used.
    * @param quellOutput A Boolean value indicating that file output should be
    * disabled.
    * @throws Exception Throws an exception if an error was encountered during
   ...
   /**
    * A helper method used to determine if the given token line has a directive
    * token.
    *
    ...
    *
    * @param lineNum An integer representing the line number of the line to
    * start searching on.
    * @param label A string representing the label that initiated the op-code
    * line search.
    ...
    * @param isOpCodeArg A Boolean value indicating if the argument is an
    * op-code argument.
    * @return The number of matching argument tokens found.
    */
   ...
   /**
    * A helper method used to clean the register range string by parsing it and
    * reassembling it.
    *
   ...
   /**
    * A helper method used to clean the token source field of line and argument
    * separators.
    *
   ...
   /**
    * A helper method used to expand the register range into individual register
    * token entries.
    *
    * @param step An integer representing the current assembly step.
    * @throws ExceptionNoEntryFound
   ...
   /**
    * A helper method used to collapse the comment tokens into sub-tokens of the
    * first comment token.
    *
    * @param step An integer representing the current assembly step.
    */
   ...
   /**
    * A helper method that is responsible for loading and parsing of the
    * instruction set JSON data file. These data files define the instruction
    * set.
    *
    * @param step An integer representing the current assembly step.
    * @throws ExceptionNoEntryFound
   ...
   /**
    * A helper method that is used to link loaded JSON object data to other
    * loaded JSON object data.
    *
    * @param step An integer representing the current assembly step.
   ...
   //LEX SOURCE CODE
   /**
    * A main method used to lexerize the assembly source code. Lexerizing, is
    * the process of converting assembly source text to artifacts.
    *
    * @param step An integer representing the current assembly step.
    * @throws IOException
    */
   ...
   /**
    * A helper method used to find a valid line entry with matching token entry
    * type.
    *
    * @param validLine A set of valid line entries to search through for a
    * matching entry type.
    ...
    * @param index An integer representing the valid line entry index. Currently
    * unused.
    * @return
    */
    ...
    * @param validLines An object the represents all the valid lines for this
    * instruction set.
   ...
   /**
    * A main method used to build binary representations of directive assembly
    * source code lines.
    *
    * @param step An integer representing the current assembly step.
         ...
         for (Token token : line.payload) {
            ...
            if (token.isDirective) {
               ...
               if (token.type_name.equals(JsonObjIsEntryTypes.NAME_NUMBER) == true) {
                  ...
                  objs = ProcessSymbolValue(token.source, entry.bit_series, token.lineNumAbs, line);
                  Integer tInt = (Integer)objs[0];
                  ...
                  */
                  ...
                  objs = ProcessShift(tInt, entry.num_range, entry.bit_shift, entry.bit_series, token.source, token.lineNumAbs, true, (isDirDcw0 == false && isDirDcw1 == false));
                  resTmp = (String)objs[0];
                  tInt = (Integer)objs[1];
    ...
    * @throws ExceptionNoSymbolValueFound 
    */
   public Object[] ProcessSymbolValue(String source, JsonObjBitSeries bit_series, int lineNumAbs, TokenLine line) throws ExceptionNoSymbolFound, ExceptionNoSymbolValueFound {
      ...
      if (sym != null) {
         resTmp1 = Utils.FormatBinString(Integer.toBinaryString(sym.addressInt), bit_series.bit_len);
      } else {
         throw new ExceptionNoSymbolFound("Could not find symbol for label '" + label + "' with line number " + lineNumAbs);
      }
      ...
      if (c == JsonObjIsEntryTypes.NAME_LABEL_REF_START_ADDRESS) {
         ...
         if (sym.value != null && sym.isStaticValue) {
            ...
            throw new ExceptionNoSymbolValueFound("Could not find symbol value for label '" + label + "' with line number " + lineNumAbs);
         }
         ...
         throw new ExceptionNoSymbolFound("Could not find symbol for label '" + label + "' with line number " + lineNumAbs + " and label prefix " + c);
      }
      
      return new Object[] {tInt, label};
   }
    ...
    * @throws ExceptionNumberOutOfRange 
    */
   public Object[] ProcessShift(Integer tIntIn, JsonObjNumRange num_range, JsonObjBitShift bit_shift, JsonObjBitSeries bit_series, String source, int lineNumAbs, boolean bitLen2x, boolean checkRange) throws ExceptionNumberInvalidShift, ExceptionNumberOutOfRange {
      Integer tInt = tIntIn;
      String resTmp1 = null;
      Integer t = null;
      ...
      if (bit_shift != null) {
         if (bit_shift.shift_amount > 0) {
            if (!Utils.IsStringEmpty(bit_shift.shift_dir) && bit_shift.shift_dir.equals(NUMBER_SHIFT_NAME_LEFT)) {
               resTmp1 = Utils.ShiftBinStr(resTmp1, bit_shift.shift_amount, false, true);
            } else if (!Utils.IsStringEmpty(bit_shift.shift_dir) && bit_shift.shift_dir.equals(NUMBER_SHIFT_NAME_RIGHT)) {
               resTmp1 = Utils.ShiftBinStr(resTmp1, bit_shift.shift_amount, true, true);
            } else {
      ...
      if(bitLen2x) {
         resTmp1 = Utils.FormatBinString(resTmp1, bit_series.bit_len * 2);
      } else {
         resTmp1 = Utils.FormatBinString(resTmp1, bit_series.bit_len);
      }
      tInt = Integer.parseInt(resTmp1, 2);
      
      if (num_range != null && checkRange) {
         if (tInt < num_range.min_value || tInt > num_range.max_value) {
            throw new ExceptionNumberOutOfRange("Integer value " + tInt + " is outside of the specified range " + num_range.min_value + " to " + num_range.max_value + " for source '" + source + "' with line number " + lineNumAbs);
         }
      }

      return new Object[] {resTmp1, tInt, blResTmp1, bltInt};
   }
   ...
   /**
    * A main method used to build binary representations of op-code assembly
    * source code lines.
    *
    * @param step An integer representing the current assembly step.
    * @param line The directive token line to build a binary representation for.
         ...
         for (BuildOpCodeThumb entry : buildEntries) {
            ...
            if (entry.isOpCode) {
               ...
               if (entry.tokenOpCodeArgGroup.type_name.equals(JsonObjIsEntryTypes.NAME_REGISTER_LOW)) {
                  ...
                  objs = ProcessSymbolValue(entry.tokenOpCodeArgGroup.source, entry.opCodeArgGroup.bit_series, entry.tokenOpCodeArgGroup.lineNumAbs, line);
                  Integer tInt = (Integer)objs[0];
                  String label = (String)objs[1];
                  ...
                  */
                  ...
                  objs = ProcessShift(tInt, entry.opCodeArgGroup.num_range, entry.opCodeArgGroup.bit_shift, entry.opCodeArgGroup.bit_series, entry.tokenOpCodeArgGroup.source, entry.tokenOpCodeArgGroup.lineNumAbs, false, true);                  
                  resTmp1 = (String)objs[0];
                  tInt = (Integer)objs[1];
                  
                  //Logger.wrl("====================================" + tInt4 + ", " + tInt);
                  //tInt = tInt4;
               ...
               if (entry.tokenOpCodeArg.type_name.equals(JsonObjIsEntryTypes.NAME_REGISTER_LOW)) {
                  ...
                  objs = ProcessSymbolValue(entry.tokenOpCodeArg.source, entry.opCodeArg.bit_series, entry.tokenOpCodeArg.lineNumAbs, line);
                  Integer tInt = (Integer)objs[0];
                  String label = (String)objs[1];                  
                  ...
                  */
                  ...
                  objs = ProcessShift(tInt, entry.opCodeArg.num_range, entry.opCodeArg.bit_shift, entry.opCodeArg.bit_series, entry.tokenOpCodeArg.source, entry.tokenOpCodeArg.lineNumAbs, false, true);                  
                  resTmp1 = (String)objs[0];
                  tInt = (Integer)objs[1];
                  String blResTmp1 = (String)objs[2];        
                  Integer bltInt = (Integer)objs[3];
